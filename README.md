...
To deploy multiple components of an SAP Landscape (HANA, ISCSI, NFS, ASCS and NW) Please refer to the installation doc here: [documentation page](https://github.com/Azure/sap-hana  .
